        ...
        {sessoes.map((sessao) => (
          <tr key={sessao.id} className="border-b border-gray-700">
            <form onChange={(e) => handleFormChange(e.currentTarget)}>
              ...
              <td className="p-3 text-center">{sessao.hora_no_ciclo}</td>
              <td className="p-3">
              ...
              <td className="p-3"><Input name="foco" defaultValue={sessao.foco || ''} className="bg-gray-700" /></td>
              <td className="p-3"><Textarea name="diario_de_bordo" defaultValue={sessao.diario_de_bordo || ''} className="bg-gray-700 h-10" /></td>
              <td className="p-3 flex items-center gap-1">
                <Input name="questoes_acertos" type="number" defaultValue={sessao.questoes_acertos || ''} className="bg-gray-700 w-16" />
                <span>/</span>
                <Input name="questoes_total" type="number" defaultValue={sessao.questoes_total || ''} className="bg-gray-700 w-16" />
              </td>
              <td className="p-3"><Input name="data_estudo" type="date" defaultValue={sessao.data_estudo || ''} className="bg-gray-700" /></td>
              <td className="p-3"><Input name="data_revisao_1" type="date" defaultValue={sessao.data_revisao_1 || ''} className="bg-gray-700" /></td>
              <td className="p-3"><Input name="data_revisao_2" type="date" defaultValue={sessao.data_revisao_2 || ''} className="bg-gray-700" /></td>
              <td className="p-3"><Input name="data_revisao_3" type="date" defaultValue={sessao.data_revisao_3 || ''} className="bg-gray-700" /></td>
            </form>
          </tr>
        ))}
      </tbody>
