...
  
  // Refs para as barras de rolagem e o conteúdo (do seu código original)
  const topScrollRef = useRef<HTMLDivElement>(null);
  const mainScrollRef = useRef<HTMLDivElement>(null);
  const contentWidthRef = useRef<HTMLDivElement>(null);

  // --- LÓGICA DE PERSISTÊNCIA DE ESTADO (À PROVA DE HIDRATAÇÃO) ---
...
  // Efeito para sincronizar as duas barras de rolagem (do seu código original)
  useEffect(() => {
...
          <Tree
            ref={treeRef} // Adicionamos a ref
            onToggle={handleToggle} // Adicionamos o handler
            data={processedData}
            onMove={handleMove}
            width="100%"
            rowHeight={40}
