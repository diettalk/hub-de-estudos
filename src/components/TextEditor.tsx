...
import { FontSize } from '@/lib/FontSize'; // Importamos a nossa nova extensão
    ...
    const editor = useEditor({
        extensions: [
            StarterKit.configure({
                // Desativa o histórico padrão para evitar conflitos com o nosso debouncedSave
                history: false, 
            }),
            Highlight.configure({ multicolor: true }),
            TextStyle, // Necessário para a cor da fonte e o tamanho
            FontSize, // A nossa extensão customizada
            Color,
            Typography,
        ...
        editorProps: {
            attributes: { class: 'prose dark:prose-invert max-w-none p-4 focus:outline-none flex-grow' },
            // Otimiza o "copiar e colar"
            handlePaste: (view, event, slice) => {
                // Deixa o Tiptap lidar com a maior parte da lógica
                return false; 
            },
        },
